...
public abstract class Union_StudyGroupStudy extends Resource
{
	...
	@ManyToMany( cascade = CascadeType.ALL, fetch = FetchType.LAZY )
	protected List<AnalysisUnit> analysisUnit;

	@ManyToMany( cascade = CascadeType.ALL, fetch = FetchType.LAZY )
	protected List<Universe> universe;

	@ManyToMany( cascade = CascadeType.ALL, fetch = FetchType.LAZY )
	protected List<Agent> publisher;

	@ManyToMany( cascade = CascadeType.ALL, fetch = FetchType.LAZY )
	protected List<Agent> contributer;

	@ManyToMany( cascade = CascadeType.ALL, fetch = FetchType.LAZY )
	protected List<Agent> creator;

	@ManyToMany( cascade = CascadeType.ALL, fetch = FetchType.LAZY )
	protected List<Agent> fundedBy;
